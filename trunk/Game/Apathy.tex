...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Acrobatics }
...
\ruledesc{ Unique skill. This
           ...
           \begin{math}{\textrm{LVL}}^{2}\times 1000\end{math} dollars in cash, equipment, or
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Arm Blades }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Abnormal Articulation }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Advanced Audio }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Climbing Feet }
\ruledesc{ A special set of
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Advanced Digestive Sys }
...
\begin{longtable}{p{1.25in}lll} 
  ...
  \hline
  \endhead
\raggedright Anti-armor (arrows only!)
           & P & 15 & -25\% dmg \tabularnewline
      ...
      \raggedright Field Point (penetration)
           & P & 10 & Bonus 0 \tabularnewline
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Anti-armor (arrows only!)
           }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ ALCAR Plate }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ 2-Headed Axe }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Arab Mace }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Boxing Irons of the Troll
           }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Ball and Chain }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Atalatl }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Cleaver }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Bastard Sword }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Whip }
\ruledesc{
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Awl Pike }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Bo Staff }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Chakram (large) }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ ALICE Rig }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Blow Gun - Long }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ ALC Plate }
\ruledesc{}\vspace{1ex}
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Air Laser }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Advanced Haste }
...
\ruledesc{  Disenchant
           ...
           effect. If disenchant is used on a spell of \begin{math}{3}^{\textrm{rd}}\end{math} rank or
           lower, then the targeted spell effect instantly expires
           (stops). If disenchant is used on a spell of \begin{math}{4}^{\textrm{th}}\end{math} rank or
...
\quotexample[Bratzner attempts to
    ...
    Five years ago Ulek the Pious cast Major Ward on a
           ...
           is \begin{math}{5}^{\textrm{th}}\end{math} rank, Disenchant does not automatically work, and
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Beast Lore 1 }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Alter Size }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Ashen cloud }
\ruledesc{ Generates a
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Animate }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Aura Sight }
\ruledesc{ Allows the caster
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Autophase }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Banshee's Wail }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Absolute Zero }
\ruledesc{ A powerful
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Archaic Weapons }
\ruledesc{  The skill
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Ambidexterity }
\ruledesc{  You are
...
\quotexample[Candlestick is ambidextrous]{
    ...
    Candlestick has 3
           ...
           at all when attacking with his \begin{math}{2}^{\textrm{nd}}\end{math} weapon, and a -3 with
           his \begin{math}{3}^{\textrm{rd}}\end{math} weapon, for instance if he were doing two punches
           and a kick.
    }
  }
...
\quotexample[Myks Deadly Reciprocal Attack]{
    ...
    Myk is typically out-of-range of any opponent
           ...
           Attack.
	    When he takes
           his \begin{math}{3}^{\textrm{rd}}\end{math} level
...
\raggedright Anticipated Dodge & Defensive & 3 & Wisdom \tabularnewline
      ...
      \raggedright Improved Anticipated Dodge
           & Defensive & 5 & Wisdom \tabularnewline
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Anticipated Dodge }
\ruledesc{  This
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Aimed Shot }
\ruledesc{  You take
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Disarm }
...
\hline
 ...
 Mech. Jump & 0 mph & 50' & 0 & 2 &\begin{math}
                          {\textrm{Size}}^{ 2 }\end{math}
                      \\

\hline

 Manuever Jets & 40 mph & 5' &  \begin{math}   (   \textrm{Size} 
                          -    1    )   
                         \times     20   \end{math}
                      & 1 &  \begin{math}{{   3 
                         \times     (   X 
...
\hline
 ...
 Jet System & 200 mph & Unlimited &  \begin{math}   (   \textrm{Size} 
                          -    1    )   
                         \times     20   \end{math}
                      & 10 & 15 \\
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Active Stealth }
...
\ruledesc{ Has 10 uses before
    ...
    \hspace{-2ex}\rulename{ Climbing System }
\ruledesc{ Range of
            \begin{math}{\textrm{Size}-1}^{2}\times 150\end{math} feet.
...
\ruledesc{ \begin{math}{\textrm{Size}}^{2}\end{math} hours in
...
\ruledesc{ Add +50\% to
           strength for \begin{math}{2}^{\textrm{Size}}\end{math} power }\vspace{1ex}
...
\ruledesc{ Repairs Size HP
           per hour (up to half of damage taken). Uses \begin{math}{\textrm{Size}}^{2}\end{math} power
           }\vspace{1ex}
...
\ruledesc{ Doubles armor.
           Power: All PC production+\begin{math}{\textrm{Size}}^{2}\end{math} }\vspace{1ex}
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Auto-Cannon }
\ruledesc{
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Beam Cannon }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Allip }
...
\begin{multicols}{2}
    \hspace{-2ex}\hspace{-2ex}\rulename{ Absent Minded Genius }
...
\ruledesc{ Character can
           control up to a total of \begin{math}{\textrm{LVL}-2}^{2}\end{math} * 30 cp worth of
...
\ruledesc{ Character can
           steal \begin{math}{\textrm{Lvl}}^{2}\end{math} * 5 MP from target, and gain \begin{math}{\textrm{Lvl}}^{2}\end{math} * 5 MP.
...
\ruledesc{ Character emits an
           odor up to 10*\begin{math}{\textrm{lvl}}^{2}\end{math} feet away. Purchase for each odor.
           }\vspace{1ex}
...
\ruledesc{ Character can
           ...
           at \begin{math}{\textrm{Lvl}}^{2}\end{math} mph. }\vspace{1ex}


    \hspace{-2ex}\rulename{ Forcefield }
\ruledesc{ Erect a FF with a
           radius of up to Lvl * 5 ft around character. Can take \begin{math}{\textrm{Lvl}}^{2}\end{math} *
...
\ruledesc{ Character can jump
           an additional \begin{math}{\textrm{Lvl}}^{2}\end{math} feet }\vspace{1ex}
...
\ruledesc{ Character emits
           enough light to illuminate (like day) an area up to 5*\begin{math}{\textrm{Lvl}}^{2}\end{math} in
           radius. }\vspace{1ex}
...
\ruledesc{ Character can
           manipulate up to \begin{math}{\textrm{Lvl}}^{3}\end{math} * 10 pounds of metal. Metal pieces may
...
\ruledesc{ Character has some
           form of natural (or mystical) covering that gives him \begin{math}{\textrm{Lvl}}^{2}\end{math}
...
\ruledesc{ Character can
           control up to \begin{math}{\textrm{Lvl}}^{2}\end{math} * 10 pounds of plant material. Can be used
...
\ruledesc{ Character gains
           Lvl sizes, gains \begin{math}{2}^{\textrm{Lvl}}\end{math} Strength, looses Lvl Dex, multiply HP
           and Base Armor by \begin{math}{2}^{\textrm{Lvl}}\end{math}. }\vspace{1ex}
...
\ruledesc{ Purchase per
           ...
           20 + \begin{math}{\textrm{lvl}}^{2}\end{math}, and purchase additional points as if the base
...
\ruledesc{ Character can
           teleport up to \begin{math}{\textrm{Lvl}}^{2}\end{math} * 5 miles away that he can see or has
           been. }\vspace{1ex}
...
\ruledesc{ Character can
           transfer \begin{math}{\textrm{Lvl}}^{2}\end{math} * 5 MP to a target per second. Requires Touch
           }\vspace{1ex}


    \hspace{-2ex}\rulename{ Unbreakable Grip }
\ruledesc{ Character can
           initiate a grip that requires a strength of STR+\begin{math}{\textrm{Lvl}}^{2}\end{math}. Adds
...
\ruledesc{ Character can
           ...
           huricanes, etc) for an area of \begin{math}{\textrm{Lvl}}^{2}\end{math} square miles. }\vspace{1ex}
...
\ruledesc{ Character can see
           through any substance that is no more than \begin{math}{\textrm{Lvl}}^{2}\end{math} feet thick.
           }\vspace{1ex}
