...
\begin{table}[htb]
  ...
  \hline
       Lift & This determines how much weight the character
                     ...
                     with handles. &  \ensuremath{  {{ STR\times STR\times BLD
                     }\over{ 10 }}   +   \texttt{
                     STR}  }
                  \\
...
\hline
 ...
 Carry & This is the amount of weight the character can
                     ...
                     of time. &  \ensuremath{  {{\texttt{Lift}}\over{ 2 }}  }
                  \\
...
\hline
 ...
 Encumbrance & This represents how much gear the character
                     ...
                     the weight and impaired mobility. &  \ensuremath{  {{  \texttt{BLD} +
                     \texttt{DEX} + \texttt{STR} 
                     }\over{ 6 }}  }
                  \\
...
\hline
 ...
 Movement & How fast the character is in `squares
                     per move-equivalent Action ' &  \ensuremath{  {{ 2  \times 
                     \texttt{STR} + \texttt{DEX}}\over{ 15 }}  }
                  \\
...
\hline
 ...
 Interaction & The basic ability of a character to interact
                     with other people. &  \ensuremath{  {{\texttt{CHA} +
                     \texttt{KNO} + \texttt{INT}}\over{ 3 }}  }
                  \\

\hline

 Hit Points & The amount of damage you can receive before
                     dying. &  \ensuremath{\texttt{BLD} + \texttt{WIL
                    }}
                  \\
...
\end{table}
   Like most of character creation, skills are purchased
    ...
    \begin{center}
    \begin{equation}
    \displaystyle\sum_{i=1}^{\texttt{Desired Level}=N}i\times \texttt{Rank}={{\texttt{Rank}\times ({N}^{2}+N)}\over{2}}
    \end{equation}
    \end{center}
...
\subsection{Contest of Attributes}
     Contests of Attributes occur whenever two characters
               ...
               roll \ensuremath{1}\textscbf{d}\ensuremath{4}\textscbf{}and add the result to their attribute. The
...
\end{table}
   The GM will give penalties and/or bonuses to your
               ...
               \ensuremath{1}\textscbf{d}\ensuremath{20}\textscbf{}for each level you have in the skill. To each die,
...
\quotexample[Investigate Mysterious Person]{ Amy is still on the Internet. Now she is
                 ...
                 bonus or negative. So Amy rolls \ensuremath{2}\textscbf{d}\ensuremath{20}\textscbf{}for the skill and
...
\subsection{All Other Rolls}
     This type of die rolling is used for just about
               ...
               appearing in a group.  Rolling dice is represented in the
                \texttt{\ensuremath{\pm}}\ensuremath{R}\texttt{+}\ensuremath{X}\textscbf{d}\ensuremath{Y}\texttt{\ensuremath{\pm}}\textscbf{Z}\textscbf{K}\footnote{ that is,
                \ensuremath{X}\textscbf{d}\ensuremath{Y}\texttt{\ensuremath{\pm}}\textscbf{Z}\textscbf{K}[\ensuremath{\texttt{\ensuremath{\pm}}\ensuremath{R}}]} format; for
               example \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}. This means that you roll three individual
               ...
               \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}. You get some four-sided dice and roll three of
               ...
               for our \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}die roll.  The same rules apply for any die. Lets say you are
               ...
               is possible. An example is \ensuremath{1}\textscbf{d}\ensuremath{4}\texttt{-}\textscbf{1}. Even if you roll a 4 on
               the die it will be reduced to a 3, which does not yield a
               rollover. No die (even after negatives) can give a value
               less than 1. So, if you have a \ensuremath{1}\textscbf{d}\ensuremath{6}\texttt{-}\textscbf{4}, and roll a 2 (which
               ...
               such as this: \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}\textscbf{}[\ensuremath{\texttt{+}\ensuremath{4}}](alt. \ensuremath{4}\texttt{+}\ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}). Raw Bonuses are
               ...
               Consider the prior example of \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}but with the [+4]
               added. That would be written \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}\textscbf{}[\ensuremath{\texttt{+}\ensuremath{4}}]. The total using
...
\section{Combat Sequence \& Initiative}
     Combat is based on a system of Rounds, Turns, and
             ...
             When combat starts, participants must roll a \ensuremath{1}\textscbf{d}\ensuremath{20}\textscbf{}for their
...
\quotexample[Lucy's turn in combat]{ It is Lucy's turn in combat and she casts
               ...
               that each turn she
               gains \ensuremath{1}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}Hit
               ...
               her \ensuremath{1}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}HP,
...
\quotexample[MSR for Bosk]{ Bosk has a STR of 17 and is brandishing a Hercules
                Club (\ensuremath{3}\textscbf{d}\ensuremath{6}\textscbf{}\textscbf{C}, MSR: 12, MSB: 13). Because Bosk's Str
                ...
                bonus: \ensuremath{ 17    -  8
                 =  9 } . So this means
                that Bosk deals \ensuremath{9}\texttt{+}\ensuremath{3}\textscbf{d}\ensuremath{6}\textscbf{}\textscbf{C} damage.
              }
...
\quotexample[Bosk with Knife]{ Suppose Bosk pulls out a long knife (\ensuremath{1}\textscbf{d}\ensuremath{6}\texttt{+}\textscbf{1}\textscbf{S}, MSR:
                 ...
                 \ensuremath{4}\texttt{+}\ensuremath{1}\textscbf{d}\ensuremath{6}\texttt{+}\textscbf{1}. }
...
\subsection{Damage}
     When an attack hits its target, it will inflict
               ...
               a dagger is a \ensuremath{1}\textscbf{d}\ensuremath{6}\textscbf{}\textscbf{P} weapon). The damage rating is the
...
\end{description}
   Consider the dagger again: \ensuremath{1}\textscbf{d}\ensuremath{6}\textscbf{}\textscbf{P}  This tells us that a strike from a Dagger deals \ensuremath{1}\textscbf{d}\ensuremath{6}\textscbf{}damage. Also, we know that it deals piercing damage.
...
\subsubsection{Fire (F)}
     Some weapons and spells have a note that says
                 ...
                 `on fire' will suffer an extra \ensuremath{1}\textscbf{d}\ensuremath{6}\textscbf{}\textscbf{U} damage
                 ...
                 \ensuremath{\times }2, which will take six
...
\quotexample[David deals Fire damage]{ David shoots a Ghoul with a Flame blaster. This
                   weapon deals \ensuremath{2}\textscbf{d}\ensuremath{6}\textscbf{}\textscbf{U} Fire. David rolls damage and ends
                   ...
                   suffer \ensuremath{1}\textscbf{d}\ensuremath{6}\textscbf{}\textscbf{U} from being on fire. This will continue
...
\quotexample[Travis's armor resists Fire damage]{ Travis is wearing Ceramic Plate armor and is
                   ...
                   The meteor round deals \ensuremath{5}\textscbf{d}\ensuremath{6}\textscbf{}\textscbf{C} + Fire and Travis's
...
\subsection{Hit Points}
     Hit Points are numbers used to represent how injured
              ...
              are generally represented as a fraction: \ensuremath{{{\texttt{
              Current HP}}\over{\texttt{Max HP}}}} . When the
...
\begin{itemize}
  ...
  \item   Small: \ensuremath{{{ 1 }\over{ 4
                   }}}
                  
  \item   Large: \ensuremath{{{ 1 }\over{ 2
                   }}}
                  
  \item   Tower: \ensuremath{{{ 3 }\over{ 4
                   }}}
...
\section{Melee}
      For damage type listed as X/Y, the weapon can deal
             ...
             bonus is always indicated with square brackets. So \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}\textscbf{}[\ensuremath{\texttt{+}\ensuremath{4}}]would be a normal \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\textscbf{1}roll, with an additional 4
...
\end{table}
                   ...
                   total HP in one blow, the pilot takes \ensuremath{1}\textscbf{d}\ensuremath{6}\texttt{+}\textscbf{1}\textscbf{U} damage.
...
\begin{table}[htb]
  ...
  \hline
  \hline
       Legs & 20 mph &  \ensuremath{   5    \times 
                           \texttt{Size}  }
                      &  \ensuremath{   (   \texttt{Size} 
                          -    1    )   
                         \times     6   }
                      & 0 & 4 \\
...
\hline
 ...
 Wheels & 50 mph & 0 &  \ensuremath{   (   \texttt{Size} 
                          -    1    )   
                         \times     2   }
                      & 1 & 3 \\
...
\hline
 ...
 Micro-hover & 20 mph & 15' &  \ensuremath{   (   \texttt{Size} 
                          -    1    )   
                         \times     10   }
                      & 4 & 8 \\
...
\hline
 ...
 True-hover & 30 mph & 200' &  \ensuremath{   (   \texttt{Size} 
                          -    1    )   
                         \times     15   }
                      & 6 & 10 \\
...
\hline
 ...
 Jump jets & 0 mph & 100' &  \ensuremath{   (   \texttt{Size} 
                          -    1    )   
                         \times     10   }
                      & 1 &
                        \ensuremath{
...
\hline
 ...
 Manuever Jets & 40 mph & 5' &  \ensuremath{   (   \texttt{Size} 
                          -    1    )   
                         \times     20   }
                      & 1 &  \ensuremath{{{   3 
                         \times     (   X 
...
\hline
 ...
 Jet System & 200 mph & Unlimited &  \ensuremath{   (   \texttt{Size} 
                          -    1    )   
                         \times     20   }
                      & 10 & 15 \\
...
\hline
 ...
 7 & 125 mm & 4 & 1 round & \ensuremath{4}\textscbf{d}\ensuremath{4}\textscbf{}\ensuremath{\times{}20}\textscbf{P} & \$200 \\

\hline

 8 & 150 mm & 5 & 1 round & \ensuremath{5}\textscbf{d}\ensuremath{4}\textscbf{}\ensuremath{\times{}20}\textscbf{P} & \$400 \\

\hline

 9 & 200 mm & 6 & 1 round & \ensuremath{5}\textscbf{d}\ensuremath{6}\textscbf{}\ensuremath{\times{}20}\textscbf{P} & \$800 \\
...
\end{description}
    When buying an energy weapon you may pay it's
               ...
               shots after the twenty-limit, roll a \ensuremath{1}\textscbf{d}\ensuremath{20}\textscbf{}with a minus
...
& Weight: \ensuremath{  {{\texttt{Height
...
& Weight: \ensuremath{  
                        {\texttt{Diameter}}^{ 3 }  \texttt{kilograms}  }  
                  \\
