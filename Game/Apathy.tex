...
\ruledesc{ Enables you to
           `create' water naturally. Usually installed on the neck, but
...
\ruledesc{ Allows you to
           ...
           steam, or chemical vapors. It wont create oxygen out of
...
\hline Over powered field & The magnetic field is stronger than normal,
                     giving a +5 STR when breaking from a lock & x2 \\

\hline High speed blade & The plasma weapon can be turned on in 0
                     actions & x1.5 \\

\hline Power burst & Once per minute the blade's power can be
...
\hspace{-2ex}\rulename{ Great Maul}
\ruledesc{ A massive wooden
           hammer originally meant for driving posts into the earth. A
           warrior with enough strength to swing a great maul could
           easily drive his opponents six feet under.}\vspace{1ex}
...
\hspace{-2ex}\rulename{ Hercules Club}
\ruledesc{ A giant club that
           requires exceptional strength to wield. The weapon is roughly
           five feet long, with half of that length being the handle. The
           striking surface is covered in spikes fashioned from stone or
           iron.}\vspace{1ex}
...
\hspace{-2ex}\rulename{ Morning Star}
\ruledesc{ A fearsome weapon
           with a well-deserved reputation for combat effectiveness. This
           is a technologically superior mace, usually fashioned entirely
           from iron. The head is covered with strong spikes, enabling
           this weapon do deal significant damage.}\vspace{1ex}
...
\hspace{-2ex}\rulename{ War Hammer}
\ruledesc{ A stout weapon
           used by the strongest of knights. A war hammer is an oversized
           sledgehammer, often sporting an iron-reinforced handle and
           spike-like striking faces. In the right hands, a warhammer is
           capable of smashing even the toughest armors.}\vspace{1ex}
...
\hline 0 & An inexpensive `trinket' type holy
...
\hline 1 & An unusually high quality trinket made by a
...
\hline 2 & A trinket or jewelry made by a master
...
\hline 3 & An artifact or relic of religious
...
\hline 4 & An artifact or relic of tremendous religious
...
\parindent=5pt
\everypar{\hangindent=20pt \hangafter=1}	   In addition, any
...
\parindent=5pt
\everypar{\hangindent=20pt \hangafter=1}Grappling
...
\parindent=5pt
\everypar{\hangindent=20pt \hangafter=1}Grapples are
...
\parindent=5pt
\everypar{\hangindent=20pt \hangafter=1}If a target is
...
\parindent=5pt
\everypar{\hangindent=20pt \hangafter=1}	       The Maximum Strength Bonus
...
\parindent=5pt
\everypar{\hangindent=20pt \hangafter=1}As in
...
\parindent=5pt
\everypar{\hangindent=20pt \hangafter=1}Note that because Multi-Weapon Style is a
...
\hline Mecha Weight (tons) & 0.5 & 1 & 2 & 16 & 125 & 1000 & 8000 & 65000 & 500000 \\

\hline Mecha CP Cost & 5 & 10 & 20 & 40 & 80 & 160 & 320 & 640 & 1280 \\

\hline Power Armor CP Cost & 1 & 4 & 9 & 16 & 25 & 50 & 100 & 200 & 400 \\
...
\hline Adamantite Alloy & +80\% & 4 & 6 & 8 & 10 & 120 \\

\hline Gundanium Alloy & +100\% & 6 & 8 & 10 & 12 & 140 \\
...
\hline Mech. Jump & 0 mph & 50' & 0 & 2 &\begin{math}
                          {Size}^{ 2 }\end{math}
                      \\

\hline Manuever Jets & 40 mph & 5' &  \begin{math}   (   Size 
                          -    1    )   
                         \times     20   \end{math}
                      & 1 &  \begin{math}{{   3 
                         \times     (   X 
...
\hline Jet System & 200 mph & Unlimited &  \begin{math}   (   Size 
                          -    1    )   
                         \times     20   \end{math}
                      & 10 & 15 \\

\hline Added Speed & +15 mph &\textit{n/a} &\textit{n/a} &\textit{n/a} & 1 & Not for jet system \\

\hline Added Speed & +50 mph &\textit{n/a} &\textit{n/a} &\textit{n/a} & 1 & For jet system only \\
...
\hline 1 & 20 mm & 1 & 20 rounds & \ensuremath{2}\textscbf{d}\ensuremath{4}\ensuremath{}\ensuremath{\times{}10}\textscbf{P} & \$10 \\

\hline 2 & 30 mm & 1 & 10 rounds & \ensuremath{2}\textscbf{d}\ensuremath{6}\ensuremath{}\ensuremath{\times{}10}\textscbf{P} & \$20 \\

\hline 3 & 40 mm & 1 & 2 rounds & \ensuremath{2}\textscbf{d}\ensuremath{4}\texttt{+}\ensuremath{1}\ensuremath{\times{}10}\textscbf{P} & \$50 \\

\hline 4 & 50 mm & 1 & 1 round & \ensuremath{3}\textscbf{d}\ensuremath{6}\ensuremath{}\ensuremath{\times{}10}\textscbf{P} & \$75 \\

\hline 5 & 75 mm & 2 & 1 round & \ensuremath{4}\textscbf{d}\ensuremath{6}\ensuremath{}\ensuremath{\times{}10}\textscbf{P} & \$100 \\

\hline 6 & 100 mm & 3 & 1 round & \ensuremath{4}\textscbf{d}\ensuremath{4}\texttt{+}\ensuremath{1}\ensuremath{\times{}10}\textscbf{P} & \$150 \\

\hline 7 & 125 mm & 4 & 1 round & \ensuremath{4}\textscbf{d}\ensuremath{4}\ensuremath{}\ensuremath{\times{}20}\textscbf{P} & \$200 \\

\hline 8 & 150 mm & 5 & 1 round & \ensuremath{5}\textscbf{d}\ensuremath{4}\ensuremath{}\ensuremath{\times{}20}\textscbf{P} & \$400 \\

\hline 9 & 200 mm & 6 & 1 round & \ensuremath{5}\textscbf{d}\ensuremath{6}\ensuremath{}\ensuremath{\times{}20}\textscbf{P} & \$800 \\
...
\hline 1 & 10 & \ensuremath{1}\textscbf{d}\ensuremath{6}\ensuremath{}\ensuremath{\times{}10}\textscbf{P} & 4 \\

\hline 2 & 15 & \ensuremath{2}\textscbf{d}\ensuremath{6}\ensuremath{}\ensuremath{\times{}10}\textscbf{P} & 6 \\

\hline 3 & 20 & \ensuremath{4}\textscbf{d}\ensuremath{6}\ensuremath{}\ensuremath{\times{}10}\textscbf{P} & 8 \\

\hline 4 & 25 & \ensuremath{8}\textscbf{d}\ensuremath{6}\ensuremath{}\ensuremath{\times{}10}\textscbf{P} & 10 \\
...
\parindent=5pt
\everypar{\hangindent=20pt \hangafter=1}We note that
