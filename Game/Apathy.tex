...
\quotexample[History$\rightarrow$Spanish]{ Ralf Gröosse-Kunstleve is a historian.
...
\subsubsection{Specialization applied to Weapon skills}
     It is also possible to specialize in weapon
                 ...
                 the shield skill. 
\quotexample[Axes$\rightarrow$Nordic War Axe]{ Bjørgen is a warrior with a liking for
