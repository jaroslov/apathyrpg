...
\end{table}
   Like most of character creation, skills are purchased
    ...
    \begin{center}
    \begin{equation}
    \displaystyle\sum_{i=1}^{N}i\times \texttt{Rank}={{\texttt{Rank}\times ({N}^{2}+N)}\over{2}}
    \end{equation}
    \end{center}
...
\subsection{All Other Rolls}
     This type of die rolling is used for just about
               ...
               for our \ensuremath{3}\textscbf{d}\ensuremath{4}\texttt{+}\ensuremath{1}die roll.  The same rules apply for any die. Lets say you are
...
\quotexample[Bosk with Knife]{ Suppose Bosk pulls out a long knife (\ensuremath{1}\textscbf{d}\ensuremath{6}\texttt{+}\ensuremath{1}\textscbf{S}, MSR:
...
\begin{description}
  ...
  \item[ Parry ]   Parrying is using your weapon to deflect a blow
...
\textscbf{Note!} \textbf{ A weapon or similar combat skill is used for
  ...
  \item[ Block ]   Blocking is putting a shield between you and an
                  incoming attack.
...
\end{description}
   Consider the dagger again: \ensuremath{1}\textscbf{d}\ensuremath{6}\ensuremath{}\textscbf{P}  This tells us that a strike from a Dagger deals \ensuremath{1}\textscbf{d}\ensuremath{6}\ensuremath{}damage. Also, we know that it deals piercing damage.
...
\begin{description}
  ...
  \item[ Hand-to-Hand attacks: ]   Hand-to-hand attacks include things like punches,
                 kicks, and body weapons (teeth, claws, etc.).
                 Hand-to-hand combat may be Parried, Dodged, or Blocked.
                 
  \item[ Melee Weapons: ]   Melee weapons are handheld weapons that are not
  ...
  \item[ Missile Weapons: ]   Missile weapons are archaic type weapons which
  ...
  \item[ Projectile Weapons: ]   Projectile weapons are guns, shotguns, rifles,
  ...
  \item[ Explosives: ]   `Explosives' in this case includes
...
\ruledesc{ The ability to
           ...
           perform acrobatics while dodging or other similar movement.
           }\vspace{1ex}
...
\ruledesc{ The character has
           ...
           tools and instruments used within the communications field.
           }\vspace{1ex}
...
\ruledesc{  The
           ...
           medical purposes, and to identify weaknesses of your foes.
          }\vspace{1ex}
...
\ruledesc{ The skill of
           ...
           law enforcement, magistrates, etc commonly possess this skill.
           }\vspace{1ex}
...
\ruledesc{ The physical
           ...
           poises, as well as selection of clothing, makeup, etc.
           }\vspace{1ex}
...
\ruledesc{ Unique skill. This
           ...
           \begin{math}{\texttt{LVL}}^{2}\times 1000\end{math} dollars in cash, equipment, or
...
\ruledesc{ The study of
           codes, including how to create, identify, and break them.
           }\vspace{1ex}
...
\ruledesc{ The study of
           ...
           this skill and the appropriate supplies can work on cyborgs.
           }\vspace{1ex}
...
\ruledesc{ The ability to
           ...
           with people in tense situations without angering them.
           }\vspace{1ex}
...
\ruledesc{ The skill of
           ...
           improvising. Being comfortable and at ease around people.
           }\vspace{1ex}
...
\ruledesc{ The skills
           ...
           perform these tasks falls under the scope of this skill.
           }\vspace{1ex}
...
\ruledesc{ Non-traditional
           ...
           drugs, etc. Choose a branch when selecting this skill (example
           }\vspace{1ex}
...
\ruledesc{ The skills of
           ...
           used for professional actors, and for espionage purposes.
           }\vspace{1ex}
...
\ruledesc{ The ability to
           ...
           this skill can cause others to become happy, sad, etc.
           }\vspace{1ex}
...
\ruledesc{ The ability to
           ...
           knowledge in the general area of the guess to be made.
           }\vspace{1ex}
...
\ruledesc{ The ability to
           ...
           than this skill. See Mecha rules for more information.
           }\vspace{1ex}
...
\ruledesc{  The
           ...
           other units in war, police, security, and similar situations.
          }\vspace{1ex}
...
\ruledesc{ The repair and
           ...
           with piping, fittings, etc. for both water and gas use.
           }\vspace{1ex}
...
\ruledesc{ The scientific
           ...
           electrical engineering), and repairing or modifying them.
           }\vspace{1ex}
...
\ruledesc{ Tying knots,
           ...
           suitability of ropes and cables for different applications.
           }\vspace{1ex}
...
\ruledesc{ The academic study
           ...
           rank than his level of this skill. (See Rune Magic system...)
           }\vspace{1ex}
...
\ruledesc{ Knowledge of how
           ...
           around in dumpsters, pawnshops, and similar locations.
           }\vspace{1ex}
...
\ruledesc{ The knowledge of
           ...
           weaknesses, as well as common tactics used to breach them.
           }\vspace{1ex}
...
\ruledesc{ The medicine skill
           applied to animals. See Medicine skill for more detail.
           }\vspace{1ex}
...
\ruledesc{ The academic study
           of animals; including their biology and their behavior, etc.
           }\vspace{1ex}
...
\ruledesc{ This device, when
           ...
           distance away. It can't store very much liquid, however.
           }\vspace{1ex}
...
\ruledesc{ Enables you to
           ...
           that normal hair styling can do, and affects the entire body
           }\vspace{1ex}
...
\ruledesc{ Improves the
           ...
           shape, size, texture, and temperature of objects touching you.
           }\vspace{1ex}
...
\ruledesc{ Replace your
           muscles with superior lab-grown ones. +1 STR and +1 BLD
           }\vspace{1ex}
...
\ruledesc{ Replaces your
           nervous system (except the brain) with an electronic network.
           }\vspace{1ex}
...
\ruledesc{ A replacement for
           ...
           giving you a +3 to STR contests, and an additional +1 BLD
           }\vspace{1ex}
...
\ruledesc{ Makes your skin
           tougher and thicker than normal. It cushions impact. (0/0/3)
           }\vspace{1ex}
...
\ruledesc{ A tail is added to
           ...
           used to hold onto things, etc. Also gives balance dex bonus
           }\vspace{1ex}
...
\ruledesc{ Adds a set of
           ...
           can retract inside the body for 2 slots and 6 more CP.
           }\vspace{1ex}
...
\ruledesc{ Character can
           ...
           facial hair. This process takes a minute of concentration.
           }\vspace{1ex}
...
\ruledesc{ The eyes can act
           like flashlights, emiting a beam of light up to 100' away
           }\vspace{1ex}
...
\ruledesc{ Acts as a file
           ...
           information contained within will never be "forgotten".
           }\vspace{1ex}
...
\ruledesc{ +1 slot in torso
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Reduced Digestive Sys }

\ruledesc{ +2 slot in torso
           }\vspace{1ex}
...
\ruledesc{ A modification to
           ...
           If your lungs are wounded, you suffer no special effects.
           }\vspace{1ex}
...
\ruledesc{ Makes the body
           quiet. It cancels the sound of the heartbeat, breathing, etc.
           }\vspace{1ex}
...
\ruledesc{ An upgrade to the
           ...
           ingest. It all but eliminates the need to excrete waste.
           }\vspace{1ex}
...
\ruledesc{ Common for hunting
           ...
           additional damage when it is pulled out of the target.
           }\vspace{1ex}
...
\ruledesc{ A typical Kevlar
           bulletproof vest. Very commonly issued to soldiers and police.
           }\vspace{1ex}
...
\ruledesc{ Leather suit worn
           ...
           considered to be zero when the rider is on a motorcycle.
           }\vspace{1ex}
...
\ruledesc{  Chain mail
           ...
           armor as the rings are known for chafing against bare skin.
          }\vspace{1ex}
...
\ruledesc{ Similar to chain
           mail, but a superior design with a higher denisty of rings.
           }\vspace{1ex}
...
\ruledesc{ Hard armor
           composed of fiberglass-epoxy plates over a kevlar interior
           }\vspace{1ex}
...
\ruledesc{ A heavy synth coat
           covered with hundreds of small hexagonal CERMET plates
           }\vspace{1ex}
...
\ruledesc{ A full chain mail
           suit completely covered with form fitting heavy steel plates
           }\vspace{1ex}
...
\ruledesc{ Heavy clothing
           lined with multiple layers of thick fur, padding, etc.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Polymer Plate }

\ruledesc{ Light hard armor
           made from advanced polymeric plates over a kevlar suit
           }\vspace{1ex}
...
\ruledesc{ Full body jumpsuit
           ...
           car drivers, pilots, etc, in the event of a crash or fire.
           }\vspace{1ex}
...
\ruledesc{ Standard SWAT
           armor: Ballistics cloth with metal plates in key locations
           }\vspace{1ex}
...
\ruledesc{ A chain mail suit
           with additional metal scales covering the chain material
           }\vspace{1ex}
...
\ruledesc{ A typical
           ...
           in combat, often proving more effective than some swords.
           }\vspace{1ex}
...
\ruledesc{ A wooden club,
           traditionally made from a gnarled tree branch or root.
           }\vspace{1ex}
...
\ruledesc{ A large hammer,
           ...
           weighing several pounds mounted atop a long wooden handle.
           }\vspace{1ex}
...
\ruledesc{ Heavy metal brass
           ...
           the following spells, but only one of the spells per day
           }\vspace{1ex}
...
\ruledesc{ A piece of metal
           ...
           fingersallowing one to deal more damage with punches.
           }\vspace{1ex}
...
\ruledesc{ An iron ball,
           often spiked, attached by a length of chain to a handle.
           }\vspace{1ex}
...
\end{longtable}
    Content/Equipment/Melee/Exotic
...
\ruledesc{ The largest of the
           ...
           such a weapon would have no problem cleaving a man in half.
           }\vspace{1ex}
...
\ruledesc{ A farming
           ...
           effective for deflecting and intercepting enemy attacks.
           }\vspace{1ex}
...
\ruledesc{ An ingenious sword
           ...
           weapon will succeed in striking his target very frequently.
           }\vspace{1ex}
...
\ruledesc{ A Southeast Asian
           ...
           kukri is just as effective as a small axe for chopping.
           }\vspace{1ex}
...
\ruledesc{ This is the
           ...
           wielded with one or two hands, and can be used my most people.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Broadsword }

\ruledesc{ Another common
           European sword. This weapon has a fairly short, wide, blade.
           }\vspace{1ex}
...
\end{longtable}
    Content/Equipment/Melee/Polearms
...
\ruledesc{ Where most
           ...
           handle would both measure somewhere around 4 feet in length.
           }\vspace{1ex}
...
\ruledesc{ A lengthy handle
           ...
           attacks, and can also be used to pull riders off their mounts.
           }\vspace{1ex}
...
\ruledesc{ Similar to a
           normal halberd, but equipped with a long, slender, blade.
           }\vspace{1ex}
...
\ruledesc{ A wooden staff
           ...
           blows, and protects the wood from damage when parrying.
           }\vspace{1ex}
...
\ruledesc{ A true fighting
           ...
           Though light and easy to swing, it can be an excellent weapon.
           }\vspace{1ex}
...
\end{longtable}
    Content/Equipment/Melee/Thrown
...
\ruledesc{ A ring-shaped
           ...
           groups on a belt hook, or slung on the warrior's arms.
           }\vspace{1ex}
...
\end{longtable}
    Content/Equipment/Miscellaneous
...
\ruledesc{ A pair of
           binoculars that folds up for easy carrying. Magnifies 4 times.
           }\vspace{1ex}
...
\ruledesc{ Very high quality
           ...
           very durable and will withstand small-caliber gunshots.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Book }

\ruledesc{ Any sort of book.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Boots }

\ruledesc{ Made for walking.
           }\vspace{1ex}
...
\ruledesc{ A 2-wheeled cart
           for an Ox, has a much deeper bed and much taller sides.
           }\vspace{1ex}
...
\ruledesc{ As above, but
           includes ice axe, crampons (spiked shoes), ice screws, etc.
           }\vspace{1ex}
...
\ruledesc{ An Elephant of War
           ...
           the only type of elephant that can be controlled in combat.
           }\vspace{1ex}
...
\ruledesc{ Leather gloves to
           protect the hands from minor cuts and abrasions while working
           }\vspace{1ex}
...
\ruledesc{ A horse that has
           ...
           Warhorse). They can stand up to 16 hands at the withers.
           }\vspace{1ex}
...
\ruledesc{ Also called a
           ...
           able to maintain speeds of 40+ mph for 6 or more hours.
           }\vspace{1ex}
...
\ruledesc{ A small tote bag
           ...
           antiseptic, scissors, simple drugs, elastic bandage, etc.
           }\vspace{1ex}
...
\ruledesc{ Portable
           telephone. Works off of satellites. Works anywhere on earth.
           }\vspace{1ex}
...
\ruledesc{ Using a move
           ...
           user's aura is modified to reflect Satan's power.
           }\vspace{1ex}
...
\ruledesc{ A flat, heavy bag
           ...
           reduce the minimum tempurature in steps of 40 degrees.
           }\vspace{1ex}
...
\ruledesc{ NOMEX clothing and
           helmet. Has no armor value, but protects wearer from fire.
           }\vspace{1ex}
...
\ruledesc{ A subbreed of the
           ...
           handle two riders. Only warhorses can be used in combat.
           }\vspace{1ex}
...
\ruledesc{ A hollow tube,
           ...
           silent attack of the blowgun to hunt animals for food.
           }\vspace{1ex}
...
\ruledesc{ This spell fires a
           ...
           the word, thus it is not affected by typical laser defenses.
           }\vspace{1ex}
...
\ruledesc{ Caster calls down
           ...
           deals double damage and the caster gets +3 to his strike roll.
           }\vspace{1ex}
...
\ruledesc{ Caster forms a
           ...
           towards any one target. (has a 50\% chance of fire effect)
           }\vspace{1ex}
...
\ruledesc{ Creates a short
           ...
           spell cannot cause damage directly, but can knock things over.
           }\vspace{1ex}
...
\ruledesc{ Tosses one target
           ...
           The armor does protect against the damage of the spell.
           }\vspace{1ex}
...
\ruledesc{ The caster summons
           ...
           cast divided by 5, and fail the casting of their spell.
           }\vspace{1ex}
...
\ruledesc{  Disenchant
           ...
           effect. If disenchant is used on a spell of \begin{math}{3}^{\texttt{rd}}\end{math} rank or
           lower, then the targeted spell effect instantly expires
           (stops). If disenchant is used on a spell of \begin{math}{4}^{\texttt{th}}\end{math} rank or
...
\quotexample[Bratzner attempts to
           disenchant]{Five years ago Ulek the Pious cast Major Ward on a
           ...
           is \begin{math}{5}^{\texttt{th}}\end{math} rank, Disenchant does not automatically work, and
...
\ruledesc{ One target
           receives +2 to all attributes for the duration of the spell.
           Target also receives +1 action and +3 to all skill rolls
           }\vspace{1ex}
...
\ruledesc{ Caster encases any
           ...
           Roll WIL vs. the intended target otherwise the spell fails.
           }\vspace{1ex}
...
\ruledesc{ Up to 4 targets
           cannot speak or cast magic for the duration of the spell
           }\vspace{1ex}
...
\ruledesc{ Creates a circular
           ...
           order to enter the circle, with the Caster at +5 to his roll.
           }\vspace{1ex}
...
\ruledesc{ Allows caster to
           communicate mentally (similar to Telepathy) with animals
           }\vspace{1ex}
...
\ruledesc{ The ground
           ...
           items to be transported must be within 10' of the caster.
           }\vspace{1ex}
...
\ruledesc{ Allows the caster
           ...
           the spell's duration unstable sections will collapse.
           }\vspace{1ex}
...
\ruledesc{ The caster's
           ...
           dealing \ensuremath{5}\textscbf{d}\ensuremath{6}\texttt{+}\ensuremath{1}x 5 U damage to everything within 50 feet.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Extinguish Fire }

\ruledesc{ Caster may
           extinguish normal fire (Magical Contro\begin{math}{l}^{2}\end{math} square yards)
           }\vspace{1ex}
...
\ruledesc{ Creates a large
           ...
           damage (with fire effect). Cannot be cast on a living target.
           }\vspace{1ex}
...
\ruledesc{ Instantly
           ...
           not eliminate the root cause of the illness in that case.
           }\vspace{1ex}
...
\ruledesc{ Target enchants
           ...
           extent of the spell. This spell does not stack with Haste.
           }\vspace{1ex}
...
\ruledesc{ Target now suffers
           ...
           attribute rolls. As well, target has -3 to all their rolls.
           }\vspace{1ex}
...
\ruledesc{ Brings one target
           ...
           the target's life thread is severed and the target dies.
           }\vspace{1ex}
...
\ruledesc{ Caster sucks away
           ...
           effect vs. undead, spirits, or non-living targets like robots)
           }\vspace{1ex}
...
\ruledesc{ Brings one dead
           ...
           intact and this spell must be cast within 24 hrs. of death.
           }\vspace{1ex}
...
\ruledesc{ Caster gains HP
           rather than suffering damage from any one incoming attack
           }\vspace{1ex}
...
\ruledesc{ Caster can
           ...
           automatic, Redirect requires a magical control roll at -3.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Blinding Flash }

\ruledesc{ Generates a
           massive flash of light (Effect = GM's discretion)
           }\vspace{1ex}
...
\ruledesc{ The caster and all
           ...
           has the Camouflage skill, he gets a bonus of 5 skill levels.
           }\vspace{1ex}
...
\ruledesc{ Caster makes his
           ...
           foot radius). Dark area moves with caster as it's center.
           }\vspace{1ex}
...
\ruledesc{ Enables caster to
           ...
           All persons in the lit area recive +2 to perception rolls.
           }\vspace{1ex}
...
\ruledesc{ One man-sized or
           ...
           (light amplification, normal vision) (cannot affect caster)
           }\vspace{1ex}
...
\ruledesc{ Creates a
           ...
           unaffected. Barrier can be made one-way for double cost.
           }\vspace{1ex}
...
\ruledesc{ Creates a
           ...
           damage. Barrier can be made one-way for double MP cost.
           }\vspace{1ex}
...
\ruledesc{ Creates a barrier
           ...
           and explodes violently and any damage done becomes permanent.
           }\vspace{1ex}
...
\ruledesc{ Magical curing
           repairs robots and machines (no effect on living tissue)
           }\vspace{1ex}
...
\ruledesc{ All beings within
           ...
           not affect the caster, demons, undead, ghosts, or spirits.
           }\vspace{1ex}
...
\ruledesc{ Caster forms a
           ...
           deals half damage, as C, to all other targets within range.
           }\vspace{1ex}
...
\ruledesc{ A soft rain falls
           from the sky, healing everything that it touches 1 HP a turn.
           }\vspace{1ex}
...
\ruledesc{ Allows caster to
           ...
           reveal the basic emotional state of the target as well.
           }\vspace{1ex}
...
\ruledesc{ All beings within
           ...
           maximum HP within range of the spell are instantly vaporized.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ White Beam }

\ruledesc{ Deals \ensuremath{1}\textscbf{d}\ensuremath{10}\ensuremath{}\textscbf{U}
           }\vspace{1ex}
...
\ruledesc{ Generates a
           circular wall, ten feet in radius, three feet thick, thirty
           feet high, with 400 hit points, of ice surrounding the caster.
           }\vspace{1ex}
...
\ruledesc{ Generates a
           ...
           wall, they take \ensuremath{2}\textscbf{d}\ensuremath{6}\ensuremath{}\textscbf{C} damage from the pummeling waters.
           }\vspace{1ex}
...
\ruledesc{ Caster throws a
           ...
           wet. The water created by the spell remains permanently.
           }\vspace{1ex}
...
\ruledesc{ Creates a large
           ...
           making a STR check at -3*size and spending three actions.
           }\vspace{1ex}
...
\begin{description}
  ...
  \item[Class]  skills are for
           individual classes of archaic weapon, such as
           Axe or Polearm. These must be bought
           individual and are Rank 1 skills.
  \item[Super Class]  skills
           are for groups of classes. These groups are:
	       
\begin{description}
    
  \item[Stick] Long Swords, Short Swords, Knives, Blunt
  \item[Axes] Axes, Blunt
  \item[Flexible] Chained, Monofilament, Ships
  \item[Great] Staves, Polearms
  \item[Missile] Ranged, Thrown
\end{description}
  
		 Super-Classes are
           Rank 2 and not Rank 1. A Super-Class may never
           be Specialized.
  \item[Exotic]  Certain weapons are Exotic (most of
...
\ruledesc{  Grappling
	      ...
	      If the
           ...
           Grappled. This is called Wrestling.}\vspace{1ex}
...
\quotexample[Rei hits harder]{Rei has decided that he wants to
...
\quotexample[Candlestick is ambidextrous]{Candlestick has 3
           ...
           at all when attacking with his \begin{math}{2}^{\texttt{nd}}\end{math} weapon, and a -3 with
           his \begin{math}{3}^{\texttt{rd}}\end{math} weapon, for instance if he were doing two punches
           and a kick.}
...
\quotexample[Uleks Fire-Bomb]{Ulek finds himself having to blast the crap out of
...
\quotexample[Bratzefv negotiates peace]{In the dark
...
\quotexample[Viterexia honorably slays her opponent]{Viterexia has just defeated the
...
\quotexample[Myk and Travis: the Machine]{Myk and
...
\quotexample[Myks Deadly Reciprocal Attack]{Myk is typically out-of-range of any opponent
           ...
           Attack.
	    When he takes
           his \begin{math}{3}^{\texttt{rd}}\end{math} level
...
\quotexample[Running a Polearm]{Travis is tired of having
...
\ruledesc{  Pick a
           ...
           variable cost Special skill in Kung Fu.
           }\vspace{1ex}
...
\quotexample[Ragnars Bar Fights]{Ragnar finds himself in more barfights than he wants,
...
\end{longtable}
    Content/Martial Arts/Defensive
...
\ruledesc{  This
           ...
           however they must all be from the same designated opponent.
           }\vspace{1ex}
...
\ruledesc{ You wait for your
           ...
           after your movement, but only if that strike is in range.
           }\vspace{1ex}
...
\ruledesc{ You attempt
           ...
           they must make a BLD check, or fall to 0 HP instantly.
           }\vspace{1ex}
...
\quotexample[Jesse `Capoeira': Double-Kick
           \& Double-Punch]{Jesse wants to perform a Capoeira-style
...
\ruledesc{ Savage allows you
           to maximize the damage dealt by an attack, for example
           }\vspace{1ex}
...
\ruledesc{ The damage (after
           ...
           negative equal to the damage taken, they fall unconscious.
           }\vspace{1ex}
...
\ruledesc{ An Isolation is an
           ...
           means. (Isolations cannot be dodged, parried, or blocked).
           }\vspace{1ex}
...
\ruledesc{ You attempt to rip
           ...
           SIZE. The grapple is automatically released at this point.
           }\vspace{1ex}
...
\begin{description}
  ...
  \item[ Slots ]   The amount of equipment that can be installed
                     on the suit 
  \item[ Armor ]   Starting armor value of the suit (All equal
                     for P/S/C) 
  \item[ Dex Minus ]   Robots have some control-lag, this is
                     represented by a DEX minus to the pilots DEX
                     attribute 
  \item[ A. Penalty ]   Armor Penalty. For every full amount of this
                     value, the DEX of the pilot is reduced by 1. 
  \item[ Power ]   is the number of PC per turn consumed by the
...
\begin{table}[htb]
  ...
  \textscbf{ Frame Material (Added HP) }&
  \textscbf{ Cost Factor }&
  \textscbf{ Very Light (-20\%) }&
  \textscbf{ Light (-10\%) }&
  \textscbf{ Medium (0\%) }&
  \textscbf{ Heavy (+10\%) }&
  \textscbf{ Very Heavy (-10\%) }\\
  \hline
  \hline
...
\begin{table}[htb]
  ...
  \hline
       Mecha &  \begin{math}    {{   2
                            \times    \texttt{Size CP} 
                         }\over{  \texttt{+1}  }}    \end{math}
                      &  \begin{math}  {{   (   \texttt{
                         Size}   -    1    )
                           \texttt{CP}  }\over{  \texttt{+1
                        }  }}  \end{math}
...
\end{longtable}
    Content/Mecha/Equipment/Auxiliary
\hspace{-2ex}\rulename{ Active Stealth }

\ruledesc{ 75\% chance of
           resisting detection by Radar or Sonar. Uses 3* SIZE PC
           }\vspace{1ex}
...
\ruledesc{ +5 Camo skill.
           Mech is invisible to light-based detection when not moving
           }\vspace{1ex}
...
\ruledesc{ +3 Camo skill.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Chaff Launcher }

\ruledesc{ Has 10 uses before
           refill. Each gives 25\% to fool RADAR sensor or Missile
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Climbing System }

\ruledesc{ Range of
            \begin{math}{\texttt{Size}-1}^{2}\times 150\end{math} feet.
            Minimum of 50'. Uses 5 PC per use
           }\vspace{1ex}
...
\ruledesc{ Travel +300 mph
           for 30 sec. Can only be used once before must be recharged
           }\vspace{1ex}
...
\ruledesc{ X*10 yard radius.
           Has 75\% chance to shut down electronic devices in the area
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Easy maintenace }

\ruledesc{ Anyone making an
           engineering or electrical roll when working on vehicle gets +2
           }\vspace{1ex}
...
\ruledesc{ \begin{math}{\texttt{Size}}^{2}\end{math} hours in
           air supply, rebreather, stops poisons and radiation fallout
           }\vspace{1ex}
...
\ruledesc{ Protects a certain
           ...
           (bullets, bombs, missiles, lasers, etc.) will destroy BOTH
           }\vspace{1ex}
...
\ruledesc{ Has 10 uses before
           refill. Each gives 25\% to fool thermal sensor or missile
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Flash System }

\ruledesc{ Gives +5 Dex; +1
           action/turn. Pilot takes D damage from combat rather than U.
           }\vspace{1ex}
...
\ruledesc{ Gives +2 to: mecha
           piloting, dodge, use of melee/HtH skills, and dex checks.
           }\vspace{1ex}
...
\ruledesc{ X*10 yard radius.
           100\% chance to shut down electronics, 50\% to destroy them.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Magical Transformation }

\ruledesc{ Everything must be
           bought for the new form. Can form into ANY other item.
           }\vspace{1ex}
...
\ruledesc{ x1.5 strength and
           -5 dex with that hand. Used for construction and punching.
           }\vspace{1ex}
...
\ruledesc{ Add +50\% to
           strength for \begin{math}{2}^{\texttt{Size}}\end{math} power }\vspace{1ex}
...
\ruledesc{ Must be bought for
           each movement system. 1 movement system is more rugged (GM).
           }\vspace{1ex}
...
\ruledesc{ Repairs Size HP
           per hour (up to half of damage taken). Uses \begin{math}{\texttt{Size}}^{2}\end{math} power
           }\vspace{1ex}
...
\ruledesc{ Doubles armor.
           Power: All PC production+\begin{math}{\texttt{Size}}^{2}\end{math} }\vspace{1ex}
...
\ruledesc{ Increases speed
           any one movement system by 50\%, doubles power required.
           }\vspace{1ex}
...
\ruledesc{ Requires slots
           equal to the slot size of a weapon / 5. Minimum of 1 slot
           }\vspace{1ex}
...
\end{longtable}
    Content/Mecha/Equipment/Ballistic
...
\ruledesc{ Deals
           ...
           feet. An ammunition pod holds 5 grenades, regardless of Class.
           }\vspace{1ex}
...
\ruledesc{ Alternately, the
           ...
           `free' energy units from the engines.
           }\vspace{1ex}
...
\ruledesc{ A variant of the
           ...
           as if it costs 5 Classes above it's normal Class.
           }\vspace{1ex}
...
\ruledesc{ A centaur is a
           ...
           peaceful and enjoy intellectual and athletic pursuits.
           }\vspace{1ex}
...
\ruledesc{ Featherlings are
           ...
           are smart and cunning, equal to a human in every aspect.
           }\vspace{1ex}
...
\ruledesc{ argoyles are
           ...
           can fly up to 20 mph. Gargoyles have a tribal society.
           }\vspace{1ex}
...
\ruledesc{ Apperance: This
           ...
           itself to the floor, waiting for the threat to go away.
           }\vspace{1ex}
...
\ruledesc{ Appearance: The
           ...
           range (and who can hear) are affected by this ability.
           }\vspace{1ex}
...
\ruledesc{ A minor
           ...
           Immune to posion \& sleep. Regenerates \ensuremath{4}\textscbf{d}\ensuremath{6}\ensuremath{}HP per turn
           }\vspace{1ex}
...
\ruledesc{ A demonic warrior
           ...
           magical ritual. Wields a serrated long sword in one hand.
           Appears much like a human, with scaly skin and a forked
           tongue. Their skin has a distinct gray hue. Has no body hair.
           }\vspace{1ex}
...
\ruledesc{ A horrible demonic
           ...
           wound is cured, the wounded portion of the SOUL remains lost.
           }\vspace{1ex}
...
\ruledesc{ Demonic creatures
           ...
           Will attack anything living that approaches their territory.
           }\vspace{1ex}
...
\ruledesc{ You recive \ensuremath{1}\textscbf{d}\ensuremath{6}\ensuremath{}to
           ...
           \texttt{-}\ensuremath{2}\texttt{+}\ensuremath{1}\textscbf{d}\ensuremath{4}\ensuremath{}to all your WIS checks and WIL related skill checks.
           }\vspace{1ex}
...
\quotexample[Ignaceous Charcot Flamme]{Ignaceous alter-identity is the mutant
	    ...
	    We note that
           ...
           skills at, i.e. levels 2, 4, and 4, respectively.}\vspace{1ex}
...
\ruledesc{ No falling damage,
           crash damage, etc. Character will bounce like a rubber ball.
           }\vspace{1ex}
...
\ruledesc{ Character can
           control up to a total of \begin{math}{\texttt{LVL}-2}^{2}\end{math} * 30 cp worth of
           spirits. The spirit must obey any commands until death.
           }\vspace{1ex}
...
\ruledesc{ Character can
           steal Lvl HP from target, and gain Lvl HP. Requires touch.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Drain MP }

\ruledesc{ Character can
           steal \begin{math}{\texttt{Lvl}}^{2}\end{math} * 5 MP from target, and gain \begin{math}{\texttt{Lvl}}^{2}\end{math} * 5 MP.
...
\ruledesc{ Once per day you
           ...
           However, you are then at -2 CHR for the rest of the day.
           }\vspace{1ex}
...
\ruledesc{ +1 on all academic
           ...
           Once per day you may add +\ensuremath{1}\textscbf{d}\ensuremath{4}\ensuremath{}to one academic skill roll.
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Emit Odor }

\ruledesc{ Character emits an
           odor up to 10*\begin{math}{\texttt{lvl}}^{2}\end{math} feet away. Purchase for each odor.
           }\vspace{1ex}
...
\ruledesc{ Character can
           ...
           at \begin{math}{\texttt{Lvl}}^{2}\end{math} mph. }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Forcefield }

\ruledesc{ Erect a FF with a
           radius of up to Lvl * 5 ft around character. Can take \begin{math}{\texttt{Lvl}}^{2}\end{math} *
...
\ruledesc{ Character can
           create a ball of darkness with radius of 15 x Lvl feet
           }\vspace{1ex}
...
\ruledesc{ Character can heal
           others with a touch. The target gains Lvl HP per turn.
           }\vspace{1ex}
...
\ruledesc{ or whatever the
           character normally needs to breeth for lvl hours at a time
           }\vspace{1ex}
...
\ruledesc{ Character can jump
           an additional \begin{math}{\texttt{Lvl}}^{2}\end{math} feet }\vspace{1ex}
...
\ruledesc{ Character takes no
           ...
           He must still walk, though he may dive into a substance.
           }\vspace{1ex}
...
\ruledesc{ Character emits
           enough light to illuminate (like day) an area up to 5*\begin{math}{\texttt{Lvl}}^{2}\end{math} in
           radius. }\vspace{1ex}
...
\ruledesc{ Character is
           ...
           cover his natural body. Others can still FEEL the character.
           }\vspace{1ex}
...
\ruledesc{ Character can
           manipulate up to \begin{math}{\texttt{Lvl}}^{3}\end{math} * 10 pounds of metal. Metal pieces may
...
\ruledesc{ Character has some
           form of natural (or mystical) covering that gives him \begin{math}{\texttt{Lvl}}^{2}\end{math}
...
\ruledesc{ Character feels NO
           ...
           he still looses HP, and will die when -HP is reached).
           }\vspace{1ex}
...
\ruledesc{ Character can
           control up to \begin{math}{\texttt{Lvl}}^{2}\end{math} * 10 pounds of plant material. Can be used
...
\ruledesc{ Character gains
           Lvl sizes, gains \begin{math}{2}^{\texttt{Lvl}}\end{math} Strength, looses Lvl Dex, multiply HP
           and Base Armor by \begin{math}{2}^{\texttt{Lvl}}\end{math}. }\vspace{1ex}
...
\ruledesc{ You recive +2 to
           ...
           You recive +1 CHR for purposes of seduction and deception.
           }\vspace{1ex}
...
\ruledesc{ Take control of
           LVL spirits whose character points are fewer than your own.
           }\vspace{1ex}
...
\ruledesc{ Purchase per
           ...
           20 + \begin{math}{\texttt{lvl}}^{2}\end{math}, and purchase additional points as if the base
...
\ruledesc{ Character can
           teleport up to \begin{math}{\texttt{Lvl}}^{2}\end{math} * 5 miles away that he can see or has
           been. }\vspace{1ex}
...
\ruledesc{ Character can
           transfer Lvl HP to a target per second. Requires Touch
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Transfer MP }

\ruledesc{ Character can
           transfer \begin{math}{\texttt{Lvl}}^{2}\end{math} * 5 MP to a target per second. Requires Touch
           }\vspace{1ex}
    
\hspace{-2ex}\rulename{ Unbreakable Grip }

\ruledesc{ Character can
           initiate a grip that requires a strength of STR+\begin{math}{\texttt{Lvl}}^{2}\end{math}. Adds
...
\ruledesc{ Character can
           ...
           huricanes, etc) for an area of \begin{math}{\texttt{Lvl}}^{2}\end{math} square miles. }\vspace{1ex}
...
\ruledesc{ Character can see
           through any substance that is no more than \begin{math}{\texttt{Lvl}}^{2}\end{math} feet thick.
           }\vspace{1ex}
